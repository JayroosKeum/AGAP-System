...
if (!$result['success']) {
    ...
    header('Location: ../../../frontend/pages/complaints/complaint-create.php');
    exit;
}

if (!empty($result['complaint_id'])) {
    header('Location: ../../../frontend/pages/complaints/complaint-details.php?id=' . (int)$result['complaint_id']);
    exit;
}
