...
class Search
{
    ...
    public function records(array $filters): array
    {
        ...
        $sql = "SELECT c.case_id, c.case_number, c.case_type, c.case_status, COALESCE(c.case_status, co.status) AS record_status, c.docket_date, co.complaint_id, co.complaint_number, co.complaint_title, co.incident_date, cc.category_name,
        ...
        $sql .= ' GROUP BY c.case_id, c.case_number, c.case_type, c.case_status, co.status, c.docket_date, co.complaint_id, co.complaint_number, co.complaint_title, co.incident_date, cc.category_name ORDER BY co.incident_date DESC, c.case_id DESC, co.complaint_id DESC LIMIT 200';
