...
$partyStmt = $db->prepare("
    SELECT cp.party_id, cp.party_type, cp.resident_id, r.first_name, r.middle_name, r.last_name
...
<div class="dashboard-layout">
    ...
    <div class="main-content">
        ...
        <div class="page-header">
            <div>
                <a href="complaint-details.php?id=<?php echo $complaintId; ?>" class="back-link">&larr; Back to Complaint Details</a>
                <h1>Edit Complaint — <?php echo htmlspecialchars($complaint['complaint_number'] ?: "CMP-#{$complaintId}"); ?></h1>
                <p>Modify incident details, case classification, involved parties, or pinned location.</p>
            </div>
        </div>
        ...
        <form id="editComplaintForm" action="../../../backend/api/complaints/update.php" method="POST" class="complaint-intake-form">
                ...
                <div class="intake-col">
                            ...
                            <?php foreach ($additionalParties as $idx => $ap): ?>
                                <div class="additional-party-row" id="partyRow_<?php echo $idx; ?>">
                                    <div class="party-row-fields">
                                        ...
                                        <button type="button" class="btn-remove-party" title="Remove party" onclick="document.getElementById('partyRow_<?php echo $idx; ?>').remove()">&times;</button>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                        </div>
                    ...
                    <div class="intake-card">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="additionalDetails" name="additional_details" rows="2" maxlength="5000" placeholder="Prior reconciliation attempts, witnesses present, injuries/damages, or other relevant facts..."><?php echo htmlspecialchars($effDetails); ?></textarea>
                        </div>
                    </div>
                </div>
            ...
            <div class="intake-actions-bar">
                <a href="complaint-details.php?id=<?php echo $complaintId; ?>" class="btn-secondary">Cancel</a>
